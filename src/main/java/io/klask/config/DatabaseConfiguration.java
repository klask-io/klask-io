...
import io.klask.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("io.klask.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("io.klask.repository.search")
