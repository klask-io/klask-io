...
@EnableConfigurationProperties({JHipsterProperties.class, LiquibaseProperties.class, KlaskProperties.class})
public class KlaskApp {

    private static final Logger log = LoggerFactory.getLogger(KlaskApp.class);
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        if (!StringUtils.isEmpty(System.getenv(Constants.MASTER_AES_KEY))){
            log.info("env variable \""+Constants.MASTER_AES_KEY+"\" is defined, so AES is activated");
        }
        log.info("\n----------------------------------------------------------\n\t" +
