...
public class CrawlerServiceTest {
    ...
    public void testExtractionPath() {
        String pathWithTrunk = "/home/jeremie/Developpement/svn/research/trunk/src/main/java/fr/dlap/research/async/package-info.java";
        String pathwithBranches = "/home/jeremie/Developpement/svn/research.test/branches/maint-15.3.x/src/main/webapp/bower_components/jquery/src/var/push.js";
        ...
        Assert.assertEquals("research", project);

        project = findProject(pathwithBranches);
        Assert.assertEquals("research.test", project);
